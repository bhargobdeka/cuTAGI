...
for dataset in datasets:
    ...
    folder_path = os.path.join("/home/bd/projects/cuTAGI/results_small_UCI_TAGI_AGVI_Het", dataset)
...
plt.savefig("/home/bd/projects/cuTAGI/results_small_UCI_TAGI_AGVI_Het/dataset_metrics_table.png", bbox_inches='tight', dpi=300)
